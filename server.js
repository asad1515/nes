...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'f!dashboard') {
    msg.reply('Dashboard ; flexbotofficial.glitch.me | Buraya girerek prefixi ayarlayınız. Botun komutları prefix ayarlanmadan çalışmaz.');
  }
});
